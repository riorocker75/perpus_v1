 <!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">YASPEN MIS AZRINA</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
            <a href="{{url('/dashboard/anggota/data')}}" class="nav-link ">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/dashboard/buku_sekolah/data')}}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Buku sekolah</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="{{url('/dashboard/buku_cerita/data')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Buku Cerita</p>
                </a>
              </li>
